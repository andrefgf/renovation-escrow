    ...
    <section id="cta" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto">{t("ctaSubtitle")}</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            <CardContent className="p-10 text-center">
              ...
              <p className="text-white/80 mb-8 leading-relaxed">{t("homeownersDesc")}</p>
              <Button
                size="lg"
          ...
          >
            <CardContent className="p-10 text-center">
              ...
              <p className="text-white/80 mb-8 leading-relaxed">{t("contractorsDesc")}</p>
              <Button
                size="lg"
                variant="outline"
        ...
        >
          <p className="text-white/60 mb-4">{t("alreadyHaveAccount")}</p>
          <Button
            variant="ghost"
